  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.hero}>
        <div>
          <p style={styles.tag}>PREMIUM INTERNSHIP PLATFORM</p>

          <h1 style={styles.title}>
            Elevate Your <span style={styles.gold}>Career Journey</span>
          </h1>

          <p style={styles.desc}>
            Discover elite internships, connect with top companies,
            and shape your future with a platform designed for ambitious students.
          </p>
        ...
        <div style={styles.heroCard}>
          <h3 style={styles.cardTitle}>Featured Opportunity</h3>
      ...
      <section style={styles.stats}>
        ...
        <div style={styles.statBox}>
          <h2 style={styles.statNumber}>1K+</h2>
          <p>Student Users</p>
        </div>
      </section>
        ...
        <div style={styles.grid}>
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureText}>
              Access curated premium internships from trusted companies.
            </p>
          </div>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureText}>
              Luxury design crafted for modern ambitious students.
            </p>
          </div>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureText}>
              Apply instantly and manage opportunities seamlessly.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={styles.cta}>
        ...
        <p style={styles.ctaText}>
          Join thousands of students building their future with InternHub.
        </p>
        ...
        >
          {isLoggedIn ? "Browse Jobs" : "Create Account"}
        </button>
      </section>
    </div>
  );
