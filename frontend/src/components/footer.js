    ...
    <footer style={styles.footer}>
      <div style={styles.top}>
        ...
        <div style={styles.brandBox}>
          ...
          <p style={styles.desc}>
            A premium internship platform crafted for ambitious students to
            discover elite opportunities and grow their careers.
          </p>
        </div>
        ...
        <div>
          ...
          <p style={styles.text}>support@internhub.com</p>
          <p style={styles.text}>Pune, Maharashtra</p>
